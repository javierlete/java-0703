...
public class VideoRestController {
	...
	@GetMapping
	public Page<Video> get(@PageableDefault(page=0, size = 3, direction = Direction.ASC, sort = "titulo") Pageable pageable) {
		return anonimoService.verListadoVideos(pageable);
	}
